...
flags.DEFINE_integer('batch_size', 32, 'how many samples to feed in each training iteration')
flags.DEFINE_integer('max_epoch', 50, 'train for max epoch')
flags.DEFINE_integer('show_every_n_epoch', 10, 'show info every this epoch')
flags.DEFINE_integer('show_every_n_iter', 1, 'show info every this iter')
